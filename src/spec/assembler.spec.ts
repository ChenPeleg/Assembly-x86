...
describe("Assembler", () => {
  ...
  it("Doesn't have side effects", () => {
    ...
    expect(JSON.stringify(program.lineMap)).toEqual(
      JSON.stringify(secondProgram.lineMap)
    );
    expect(JSON.stringify(program.instructions)).toEqual(
      JSON.stringify(secondProgram.instructions)
    );
    expect(JSON.stringify(program.memoryDefinitions)).toEqual(
      JSON.stringify(secondProgram.memoryDefinitions)
    );
  });
  ...
  it("Correctly handles data definitions", () => {
    ...
    expect(memoryDefinitions.length).toEqual(
      20,
      "Length of definitions should be 20"
    );
